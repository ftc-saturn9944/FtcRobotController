...
@Autonomous(name="Blue - Left (Goal) - Park", group="Blue", preselectTeleOp = "RobotTeleOpField")
public class BlueLeftPark extends CommandOpMode {
    ...
    public void initialize() {
        ...
        telemetry.addLine("-- Blue Left Autonomous --");
