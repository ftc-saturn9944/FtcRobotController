...
public class AutonomousReverse extends CommandBase {
    ...
    public AutonomousReverse(MecanumSubsystem subsystem, CameraSubsystem camera, RevIMU imu, Boolean field) {
        m_drive = subsystem;
        m_field = field;
        m_imu = imu;
        m_camera = camera;
    ...
    public void initialize() {
        m_timer = new Timing.Timer(m_camera.getReverseTime(), TimeUnit.MILLISECONDS);
        m_timer.start();
    }
