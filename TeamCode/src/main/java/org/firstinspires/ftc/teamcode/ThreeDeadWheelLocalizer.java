...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2873; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3174; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1489; // x position of the perpendicular encoder (in tick units)
    }
